...
namespace GnomeDistort2Processing {
    inline static const std::function<float(float)> GetWaveshaperFunction(const GnomeDistort2Parameters::Options::WaveshaperFunction& func, const float& amount) {
        using namespace GnomeDistort2Parameters::Options;
        switch (func) {
            case HardClip:
