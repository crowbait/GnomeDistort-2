...
namespace GnomeDistort2Theme {
    static const Theme getTheme_CleanLightBlue() {
        Theme r;
        ...
        r.COLOR_KNOB_INDICATOR_IN = juce::Colour(10u, 10u, 110u);
        r.COLOR_KNOB_INDICATOR_OUT = juce::Colour(36u, 36u, 36u);
        r.COLOR_CIRCUIT_PRIMARY = juce::Colour(10u, 10u, 110u);
        r.COLOR_GRAPH_BG = juce::Colour(210u, 210u, 210u);
        r.COLOR_GRAPH_PRIMARY = juce::Colour(10u, 10u, 110u);
        r.COLOR_GRAPH_SECONDARY = juce::Colour(90u, 90u, 90u);
        r.COLOR_BAND_LEVEL_MAX = juce::Colour(10u, 10u, 110u);
        ...
        r.COLOR_CMBBX_ARROW = juce::Colour(10u, 10u, 110u);
        ...
        r.Gnome = juce::ImageCache::getFromMemory(BinaryData::gnome_dark_blue_png, BinaryData::gnome_dark_blue_pngSize);
