...
bool GnomeDistort2AudioProcessor::acceptsMidi() const
{
...
bool GnomeDistort2AudioProcessor::producesMidi() const
{
...
bool GnomeDistort2AudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
//==============================================================================
bool GnomeDistort2AudioProcessor::hasEditor() const
{
